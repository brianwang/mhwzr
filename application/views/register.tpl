        ...
        <form action="{site_url('/user/register')}" method="post">
            <div class="content_left">
                <div class="reg_box">
                    ...
                    <p><span class="textinput_label">确认密码：</span><input class="text_name" type="text"  name="confirmpassword"></p>
                    ...
                    <p><span class="textinput_label">密保答案：</span><input type="text" name="answer" placeholder=“答案”></p>

                    <p><span class="textinput_label">验证码：</span><input class="text_name small_width" type="text" name="verifycode"></p>
            ...
            <div>
                <p class="checkbox">
                    <input type="checkbox" id="" value=""><span>我已经阅读并接受</span>
                    <a class="forget_password" href="#">《注册协议和版权声明》</a></p>
            </div>
            <div class="d_btn_reg">
                <a class="btn p_bold p_size_14 p_clor_ffffff" href="#">注册</a>
            </div>
